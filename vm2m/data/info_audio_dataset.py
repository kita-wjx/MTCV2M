...
e.g. description, text transcription, video etc.
"""
...
from ..models.conditioners import SegmentWithAttributes, ConditioningAttributes
...
class InfoAudioDataset(AudioDataset):
    ...
    See `audio_dataset.AudioDataset` for initialization arguments.
    """
