...
from ..models.conditioners import ConditioningAttributes
...
class BaseGenModel(ABC):
    ...
    def _prepare_tokens_and_attributes(
        ...
        Args:
            videos (list of str): A list of strings used as video conditioning.
        ...
        if prompt is not None:
            if videos is not None:
                assert len(videos) == len(prompt), "Prompt and nb. descriptions doesn't match"
    ...
    def generate(self, videos: tp.List[str], progress: bool = False, return_tokens: bool = False) \
        ...
        Args:
            ...
            progress (bool, optional): Flag to display progress of the generation process. Defaults to False.
        """
        attributes, prompt_tokens = self._prepare_tokens_and_attributes(videos, None)
